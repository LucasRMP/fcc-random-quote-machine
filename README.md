...
- [ ] **User Story #3:** I can see an element with a corresponding `id="author"`.

- [ ] **User Story #4:** I can see a clickable element with a corresponding `id="new-quote"`.
...
- [ ] **User Story #10:** I can tweet the current quote by clicking on the `#tweet-quote` element.
